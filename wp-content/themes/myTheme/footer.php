<footer class="bg-body-tertiary text-center text-lg-start content-black">
...
<div class="container-lg py-5">
  ...
  <div class="row">
    ...
    <div class="col-lg-4 col-md-12 mb-4 mb-md-0">
      ...
      <img class="header-icon" alt="G6 Portfolio footer logo" src="<?php echo get_template_directory_uri() ?>/image/favicon_io/footer-favicon-32x32.png"?>
